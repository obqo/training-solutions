...
public class EmployeeTest {
    ...
    public void testCreateWithNegativeSalary() {
        ...
        assertEquals("Salary must be positive and must be divisible by 1000", ex.getMessage());
    }

    @Test
    public void testCreateWithNotDiv1000Salary() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> new Employee("Kis Géza", "minőségellenőr", 200100));
        assertEquals("Salary must be positive and must be divisible by 1000", ex.getMessage());
    }
